...
namespace NekoForWindows
{
    public partial class frmHome : Form
    {
        ...
        public void LoadConfigurattion()
        {
            ...
            btnConfigName.Text = Properties.Settings.Default.ConfigSelect;
            btnRunningModeName.Text = Properties.Settings.Default.ConfigEnhanced.ToUpper();
        }
        ...
        static string CONFAR = $"-d {NEKODIR} -f {Properties.Settings.Default.ConfigSelect}";
        ...
        private void btnEnable_Click(object sender, EventArgs e)
        {
            if (statusEnable())
            {
                try
                {
                    if (File.Exists(Properties.Settings.Default.ConfigSelect))
                        StartNeko();
                    else
